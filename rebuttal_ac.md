...
- Discussed the strength of intra-cluster correlations in the real applications and how our numerical settings align with them.   
...
#### **3. Methodology:**
- Clarified that our method focuses on between-episode correlations and does not explicitly address within-episode correlations, which is a limitation for future work.
...
- Highlighted the differences between GFQI and FQI.   
